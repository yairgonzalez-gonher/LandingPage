// This component ensures Tailwind detects all dynamic class combinations
// It's hidden but imported to guarantee classes are available at build time

export default function TailwindClassGenerator() {
  // This component is never rendered, but imports it ensures
  // Tailwind's JIT compiler includes these class combinations
  return null;
}
...
const allThemeClasses = `
  ...
  from-purple-500 from-cyan-500 from-emerald-500 from-red-500
  to-indigo-600 to-purple-600 to-cyan-500 to-emerald-500 to-red-500
  bg-gray-900 bg-gray-800 bg-gray-700 bg-gray-600 bg-gray-500 bg-gray-400 bg-gray-300 bg-gray-200 bg-gray-100 bg-gray-50 bg-white
  text-gray-900 text-gray-800 text-gray-700 text-gray-600 text-gray-500 text-gray-400 text-gray-300 text-gray-200 text-white
  border-gray-900 border-gray-800 border-gray-700 border-gray-600 border-gray-500 border-gray-400 border-gray-300 border-gray-200
