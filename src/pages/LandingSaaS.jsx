...
export default function LandingSaaS() {
  ...
  const features = [
    { icon: <FaCloud size={32} />, title: 'Factuflow', desc: 'Automatizacion de Tickets y Facturas para tu Negocio', badge: 'Ver mas', href: '/soluciones/factuflow' },
    { icon: <FaShieldAlt size={32} />, title: 'Forgeon', desc: 'ERP que automatiza y hace mas facil las actividades de tu Empresa', badge: 'Ver mas', href: '/soluciones/forgeon' },
    ...
    { icon: <FaSync size={32} />, title: 'CRM (TBD)', desc: 'Manejo y control de tus clientes mas facil, asi como su acercamiento con ellos', badge: 'Proximamente', href: '/soluciones/crm', disabled: true },
